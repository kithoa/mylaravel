                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="dangnhap" method="post" role="form">
                                   ...
                                   @endif
                                   <input type="text" name="tentk" class="form-control" placeholder="Nhập tên đăng nhập" required="">
                                   <input type="password" name="matkhau" class="form-control" placeholder="Nhập mật khẩu" required="">
                                   <button class="submit-btn form-control" id="form-submit">Đăng nhập</button>
                              </form>
                         </div>
                    </div>
