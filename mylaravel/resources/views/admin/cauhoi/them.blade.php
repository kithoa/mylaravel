...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Tạo câu hỏi</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form action="admin/cauhoi/them" method="post" role="form">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="chuong">
                                         @foreach($chuong as $c)
                                        <option value="{{$c->id}}">{{$c->TenChuong}}</option>
                                        @endforeach 
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Thang điểm</label>
                                    <input name="thangdiem" class="form-control" placeholder="Nhập thang điểm">
                                </div>
                                <div class="form-group">
                                    <label>Nội dung câu hỏi </label>
                                    <input name="noidungch" class="form-control" placeholder="Nhập nội dung câu hỏi">
                                </div>
                                <div class="form-group">
                                    <label>Nhập A </label>
